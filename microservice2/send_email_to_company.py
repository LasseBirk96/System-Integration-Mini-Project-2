...
COOPERATE_EMAIL = "testtilmitpythonprojekt@gmail.com"
...
def send():
    ...
    for element in some_list:
        ...
        email_message = f"There is a new complaint from {email}, please address this as fast as possible. The complaint goes as follows {complaint}".format(email, complaint)
